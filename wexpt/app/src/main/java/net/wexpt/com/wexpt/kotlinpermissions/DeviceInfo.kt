...
public class DeviceInfo {
    companion object {
        ...
        @JvmStatic
        fun getScreenDisplayID(context: Context): String {
            var result: String? = null
            try {
        ...
        @TargetApi(Build.VERSION_CODES.LOLLIPOP)
        @JvmStatic
        fun getStringSupportedABIS(): String {
            var result: String? = null
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        @TargetApi(Build.VERSION_CODES.LOLLIPOP)
        @JvmStatic
        fun getSupported32bitABIS(): Array<String> {
            var result: Array<String>? = arrayOf("-")
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        @JvmStatic
        fun getLatLong(context: Context): DoubleArray {
        ...
        @JvmStatic
        @SuppressWarnings("MissingPermission")
        fun getAccounts(context: Context): Array<String?>? {
            try {
